...
try { fs.unlinkSync('../texts_zh.js') } catch (e) { }
const lineWriter = fs.createWriteStream('../texts_zh.js', { flags: 'a' })
lineWriter.write(`zh={};`)
const rx = /^([^=]+)=(.*)/
...
try { fs.unlinkSync('../texts_en.js') } catch (e) { }
const lineWriter2 = fs.createWriteStream('../texts_en.js', { flags: 'a' })
